...
class List extends React.Component {
    ...
    render() {
        ...
        //Create
        let createAdminLink = this.renderRedirectCreate('/admin/products/creer')
        let createSuperAdminLink = this.renderRedirectCreate('/sadmin/products/creer')
        let authorizedCreate;
        //Edit
        let editAdminLink = this.renderRedirectEdit('/admin/products/modifier')
        let editSuperAdminLink = this.renderRedirectEdit('/sadmin/products/modifier')
        let authorizedEdit;
                ...
                <Row>
                    <Col>
                        <Card className='Recent-Users'>
                            <Card.Header>
                                <Card.Title as="h5">Liste des produits&nbsp;&nbsp;
                                   {addProduct()}
                                    {button}
                                </Card.Title>
                            </Card.Header>
